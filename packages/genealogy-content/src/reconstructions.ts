  ...
  nodes: [
    {
      ...
      detail: 'Testator whose 1779 will names twelve children and no wife.',
      kind: 'person',
    ...
    ...[
      ...
      ['will-john', 'John'],
      ['will-hannah', 'Hannah'],
      ['will-rachel-worthington', 'Rachel Worthington, wife of Robert'],
      ['will-sarah-prescot', 'Sarah Meason Briscoe/Brescol'],
      ['will-ann', 'Ann'],
      ['will-mary', 'Mary'],
  ...
  timeline: [
    {
      ...
      detail:
        'The will records twelve children, including daughters Ann and Hannah; it names no wife, and Benjamin is not named.',
      referenceIds: [18],
    },
    {

  ...
  return {
    ...
    paths: {
      '/api/mcp-server': {
        ...
        post: {
          ...
          description: 'Main MCP server endpoint supporting JSON-RPC 2.0 protocol. Handles initialization, tool discovery, and tool execution.',
          requestBody: {
            required: true,
            content: {
              'application/json': {
    ...
    components: {
      schemas: {
        MCPTools: {
          type: 'object',
          description: 'Available MCP tools for accessing professional information',
          properties: {
            contact: {
              type: 'object',
            ...
            'full-profile': {
              ...
              properties: {
                ...
                outputSchema: {
                  type: 'object',
                  properties: {
                    contact: { $ref: '#/components/schemas/MCPTools/properties/contact/properties/outputSchema/properties/contact' },
                    bio: { type: 'string' },
                    resume: { $ref: '#/components/schemas/MCPTools/properties/resume/properties/outputSchema/properties/resume' },
                    projects: { $ref: '#/components/schemas/MCPTools/properties/projects/properties/outputSchema/properties/projects' }
                  }
                }
              }
            }
    ...
    tags: [
      ...
      },
      {
        ...
        description: 'Access to contact details, biography, work experience, and projects'
      }
    ]
  };
}

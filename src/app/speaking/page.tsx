                  ...
                  <div className="flex items-start gap-4">
                      ...
                      <div className="w-12 h-12 bg-red-100 rounded-lg flex items-center justify-center">
                        ...
                        >
                          <path
                            ...
                            strokeLinejoin="round"
                            strokeWidth="2"
                            d="M14.828 14.828a4 4 0 01-5.656 0M9 10h1m4 0h1M9 16v-4a4 4 0 118 0v4M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2z"
                          />
                        </svg>
                      </div>
                    </div>
                    <div>
                      ...
                      <p className="text-gray-700 text-sm mb-4">
                        Conference talks and live demonstrations showcasing XM
                        Cloud architecture and deployment innovations.
                      </p>
                      <div className="space-y-2">
                        {videoPresentations.map(
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="w-full">
                      ...
                      <p className="text-gray-700 text-sm mb-4">
                        In-depth discussions on CMS architecture, XM Cloud
                      ...
                      {featuredMedia && (
                        <div className="mb-6">
                          ...
                          <p className="text-gray-700 text-sm mb-4">
                            Featured guest discussing &ldquo;
                            {featuredMedia.episode}&rdquo; -{" "}
                              ...
                              >
                                ...
                                >
                                  <path
                                    ...
                                    strokeLinejoin="round"
                                    strokeWidth="2"
                                    d="M14.828 14.828a4 4 0 01-5.656 0M9 10h1m4 0h1M9 16v-4a4 4 0 118 0v4M5 20h14a2 2 0 002-2V6a2 2 0 00-2 2v14a2 2 0 002 2z"
                                  />
                                </svg>
                              </a>
                            )}
                      ...
                      <p className="text-gray-700 mb-4">
                        {presentation.isFeatured && (
                          <span className="text-red-600 font-medium mr-2">
                            &ldquo;Andy&apos;s Personal Favorite&rdquo; -{" "}
                          </span>
                        )}
                      ...
                      {presentation.documentationQuote && (
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                          <p className="text-blue-800 text-sm">
                            <strong>{presentation.documentationSource}:</strong>{" "}
              ...
              <div className="bg-gradient-to-r from-gray-900 to-gray-800 rounded-lg p-8 text-white">
                <div className="max-w-3xl mx-auto text-center">
                  ...
                  <p className="text-gray-300 leading-relaxed mb-6">
                    Every presentation, podcast appearance, and community
                    interaction is an opportunity to advance our collective
                    understanding of what&apos;s possible with modern CMS
                    architecture. From the founding days of{" "}
                    {addSitecoreLinks("XM Cloud")} to today&apos;s AI-driven
                    innovations, the goal is always to help others build better
                    digital experiences.
                  </p>

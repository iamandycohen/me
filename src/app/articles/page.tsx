        ...
        <div className="container-max">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              Exploring the intersection of AI, digital experience platforms, and software architecture. 
              Insights from building and scaling enterprise systems in the age of AI.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-r from-primary-50 to-secondary-50 rounded-lg p-6 mb-12 border border-primary-100">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                <div>
                  <div className="text-3xl font-bold text-primary-700">{thoughtLeadership.length}</div>
                  <div className="text-sm text-gray-600">Articles</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-primary-700">
                    {thoughtLeadership.filter(a => a.platform === "LinkedIn").length}
                  </div>
                  <div className="text-sm text-gray-600">LinkedIn</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-primary-700">
                    {thoughtLeadership.filter(a => a.platform === "CMS Critic").length}
                  </div>
                  <div className="text-sm text-gray-600">CMS Critic</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-primary-700">2025</div>
            ...
            <div className="space-y-8">
              {thoughtLeadership.map((article: ThoughtLeadership, index: number) => (
                <article
                  key={index}
                ...
                >
                  ...
                  <div className="mb-6">
                    ...
                    <div className="flex flex-wrap items-center gap-2 text-sm text-gray-600">
                      <span className="font-medium text-primary-600">{article.platform}</span>
        ...
        <div className="container-max">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Interested in discussing AI, digital experience platforms, or software architecture? 
              I'm always up for conversations about the future of technology.
            </p>

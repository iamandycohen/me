...
export const metadata = generatePageMetadata(
  ...
  data.contact,
  {
    other: {
      ...
      'ai:skills-demonstrated': 'hands-on building,engineering design,craftsmanship',
        ...
        <div className="container-max">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Creative projects that showcase the same engineering mindset and attention to detail 
              I bring to digital platforms and enterprise architecture.
            </p>
          </div>
        </div>
      </section>
              ...
              <div key={index} className="card overflow-hidden">
                <div className="grid lg:grid-cols-2 gap-8 items-start">
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-4">Engineering Highlights</h3>
                    ...
                    <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                      ...
                      <div className="grid sm:grid-cols-2 gap-4 text-sm">
                        ...
                        <div>
                          ...
                          <span className="text-gray-600 ml-2">12 feet above ground</span>
                        </div>
                        <div>
                          <span className="font-medium text-gray-900">Season Rating:</span>
                          <span className="text-gray-600 ml-2">4-season weatherproofing</span>
                        </div>
                        <div>
                          <span className="font-medium text-gray-900">Construction:</span>
                          <span className="text-gray-600 ml-2">Custom built from concept</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-primary-50 rounded-lg p-6 border border-primary-200">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <p className="text-primary-800 font-medium mb-2">Engineering Philosophy</p>
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-max">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              From enterprise platforms serving millions to treehouses delighting children, 
              I believe in applying engineering excellence to everything I build.
            </p>
